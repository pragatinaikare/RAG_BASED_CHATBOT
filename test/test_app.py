...
def test_chatbot(driver):
    ...
    driver.get("https://polar-beach-12894-bd2bc423e043.herokuapp.com/")
    ...
    assert (after_click_user_text == "Hi Tell me about the CSCE texas A&M") and (after_click_bot_text is not None)
